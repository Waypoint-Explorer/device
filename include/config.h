...
#define CALIBRATE_SENSOR_TASK_PRIORITY tskIDLE_PRIORITY

#define UPDATE_BY_TIMER_TASK_WORDS 10000
#define UPDATE_BY_TIMER_TASK_PRIORITY 5

#define UPDATE_BY_BUTTON_TASK_WORDS 10000
#define UPDATE_BY_BUTTON_TASK_PRIORITY 10

// Display setting
#define DISPLAY_ROTATION 1

// Gps setting
#define GET_GPS_DATA_COUNT 6

// Sensor setting
#define SENSOR_CALIBRATION_CYCLES 7
